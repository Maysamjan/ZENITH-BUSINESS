...
- **P6 UI + print.** `ui/documents/sales_report_page.py` — period presets, custom
  ...
  printable report on the **existing A4/A5 preview standard**, using the **CUSTOMER's**
  business identity (logo / name / address / phone) from Company settings — never the
  Zenith Soft developer identity.

**Verification.** Full suite **427 pass** (+30: engine reconciliation, partial-paid
