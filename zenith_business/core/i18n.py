...
_CATALOG: dict[str, dict[str, str]] = {
    ...
    "items.col_opening_stock": {LANG_ENGLISH: "Opening Stock",
                                LANG_DARI: "موجودی اولیه"},
    "items.col_current_stock": {LANG_ENGLISH: "Current Stock",
                                LANG_DARI: "موجودی فعلی"},
    "items.msg_opening_needs_wh": {
        LANG_ENGLISH: "Choose a warehouse for the opening stock. Create one under "
                      "Base Data → Warehouses first if there is none.",
        LANG_DARI: "برای موجودی اولیه یک گدام انتخاب کنید. اگر گدامی وجود ندارد، "
                   "ابتدا از اطلاعات پایه ← گدام‌ها یکی بسازید.",
    },
    ...
    # Suppliers screen — a supplier-shaped view of the same people.
    "sup.title": {LANG_ENGLISH: "Suppliers", LANG_DARI: "تأمین‌کنندگان"},
    "sup.new": {LANG_ENGLISH: "New Supplier", LANG_DARI: "تأمین‌کننده جدید"},
    "sup.view_ledger": {LANG_ENGLISH: "View Account", LANG_DARI: "مشاهده حساب"},
    "sup.col_code": {LANG_ENGLISH: "Supplier Code", LANG_DARI: "کود تأمین‌کننده"},
    "sup.col_name": {LANG_ENGLISH: "Name", LANG_DARI: "نام"},
    "sup.col_business": {LANG_ENGLISH: "Business Name", LANG_DARI: "نام تجارتی"},
    "sup.col_phone": {LANG_ENGLISH: "Phone", LANG_DARI: "تیلیفون"},
    "sup.col_balance": {LANG_ENGLISH: "Current Balance", LANG_DARI: "بیلانس فعلی"},
    "sup.col_purchases": {LANG_ENGLISH: "Total Purchases", LANG_DARI: "مجموع خریداری"},
    "sup.col_paid": {LANG_ENGLISH: "Total Paid", LANG_DARI: "مجموع پرداختی"},
    "sup.col_payable": {LANG_ENGLISH: "Remaining Payable", LANG_DARI: "باقی قابل پرداخت"},
    "sup.col_status": {LANG_ENGLISH: "Status", LANG_DARI: "وضعیت"},
    "nav.suppliers": {LANG_ENGLISH: "Suppliers", LANG_DARI: "تأمین‌کنندگان"},
    ...
    "s4.col_total": {LANG_ENGLISH: "Net Total", LANG_DARI: "مجموع خالص"},
    "s4.col_gross": {LANG_ENGLISH: "Invoiced", LANG_DARI: "صورت‌حساب"},
    "s4.col_returned_total": {LANG_ENGLISH: "Returned", LANG_DARI: "برگشتی"},
    ...
    "s4.return_note_line": {LANG_ENGLISH: "{item} — Qty {qty} returned.",
                            LANG_DARI: "{item} به تعداد {qty} دانه برگشت شد."},
    ...
    "inv.nav_stock": {LANG_ENGLISH: "Inventory", LANG_DARI: "موجودی"},
    "inv.nav_adjust": {LANG_ENGLISH: "Stock Adjustment", LANG_DARI: "تعدیل موجودی"},
    "inv.nav_transfer": {LANG_ENGLISH: "Warehouse Transfer", LANG_DARI: "انتقال بین گدام"},
    "inv.nav_movements": {LANG_ENGLISH: "Stock Movement", LANG_DARI: "حرکت موجودی"},
    "inv.nav_reports": {LANG_ENGLISH: "Inventory Reports", LANG_DARI: "گزارش‌های موجودی"},
    "inv.stock_title": {LANG_ENGLISH: "Inventory", LANG_DARI: "موجودی"},
    "inv.adjust_title": {LANG_ENGLISH: "Stock Adjustment", LANG_DARI: "تعدیل موجودی"},
    "inv.transfer_title": {LANG_ENGLISH: "Warehouse Transfer", LANG_DARI: "انتقال بین گدام"},
    "inv.movements_title": {LANG_ENGLISH: "Stock Movement History",
                            LANG_DARI: "سابقه حرکت موجودی"},
    "inv.reports_title": {LANG_ENGLISH: "Inventory Reports", LANG_DARI: "گزارش‌های موجودی"},
    # columns
    "inv.col_item_code": {LANG_ENGLISH: "Item Code", LANG_DARI: "کود جنس"},
    "inv.col_item_name": {LANG_ENGLISH: "Item Name", LANG_DARI: "نام جنس"},
    "inv.col_unit": {LANG_ENGLISH: "Unit", LANG_DARI: "واحد"},
    "inv.col_opening": {LANG_ENGLISH: "Opening Stock", LANG_DARI: "موجودی اولیه"},
    "inv.col_current": {LANG_ENGLISH: "Current Stock", LANG_DARI: "موجودی فعلی"},
    "inv.col_minimum": {LANG_ENGLISH: "Minimum", LANG_DARI: "حداقل"},
    "inv.col_difference": {LANG_ENGLISH: "Difference", LANG_DARI: "تفاوت"},
    "inv.col_warehouse": {LANG_ENGLISH: "Warehouse", LANG_DARI: "گدام"},
    "inv.col_status": {LANG_ENGLISH: "Stock Status", LANG_DARI: "وضعیت موجودی"},
    "inv.col_qty": {LANG_ENGLISH: "Quantity", LANG_DARI: "مقدار"},
    "inv.col_date": {LANG_ENGLISH: "Date", LANG_DARI: "تاریخ"},
    "inv.col_type": {LANG_ENGLISH: "Type", LANG_DARI: "نوع"},
    "inv.col_in": {LANG_ENGLISH: "In", LANG_DARI: "ورود"},
    "inv.col_out": {LANG_ENGLISH: "Out", LANG_DARI: "خروج"},
    "inv.col_balance": {LANG_ENGLISH: "Balance", LANG_DARI: "مانده"},
    "inv.col_document": {LANG_ENGLISH: "Document", LANG_DARI: "سند"},
    "inv.col_user": {LANG_ENGLISH: "User", LANG_DARI: "کاربر"},
    "inv.col_note": {LANG_ENGLISH: "Reason / Note", LANG_DARI: "دلیل / یادداشت"},
    # ---- Stage 09 accounting reports & financial statements ----
    "acc.nav_reports": {LANG_ENGLISH: "Financial Statements",
                        LANG_DARI: "صورت‌های مالی"},
    "acc.reports_title": {LANG_ENGLISH: "Financial Statements",
                          LANG_DARI: "صورت‌های مالی"},
    "acc.rep_trial_balance": {LANG_ENGLISH: "Trial Balance", LANG_DARI: "میزان آزمایشی"},
    "acc.rep_profit_loss": {LANG_ENGLISH: "Profit & Loss", LANG_DARI: "مفاد و ضرر"},
    "acc.rep_balance_sheet": {LANG_ENGLISH: "Balance Sheet", LANG_DARI: "بیلانس"},
    "acc.rep_general_ledger": {LANG_ENGLISH: "General Ledger", LANG_DARI: "دفتر کل"},
    "acc.rep_cash_bank": {LANG_ENGLISH: "Cash & Bank", LANG_DARI: "نقد و بانک"},
    "acc.rep_receivables": {LANG_ENGLISH: "Receivables", LANG_DARI: "طلبات"},
    "acc.rep_payables": {LANG_ENGLISH: "Payables", LANG_DARI: "بدهی‌ها"},
    "acc.f_period": {LANG_ENGLISH: "Period", LANG_DARI: "دوره"},
    "acc.f_from": {LANG_ENGLISH: "From", LANG_DARI: "از تاریخ"},
    "acc.f_to": {LANG_ENGLISH: "To", LANG_DARI: "تا تاریخ"},
    "acc.f_account": {LANG_ENGLISH: "Account", LANG_DARI: "حساب"},
    "acc.filter_all_accounts": {LANG_ENGLISH: "All accounts", LANG_DARI: "همه حساب‌ها"},
    "acc.period_fy": {LANG_ENGLISH: "Financial year", LANG_DARI: "سال مالی"},
    "acc.period_year": {LANG_ENGLISH: "This year", LANG_DARI: "امسال"},
    "acc.period_month": {LANG_ENGLISH: "This month", LANG_DARI: "این ماه"},
    "acc.period_custom": {LANG_ENGLISH: "Custom dates", LANG_DARI: "تاریخ دلخواه"},
    "acc.col_code": {LANG_ENGLISH: "Code", LANG_DARI: "کود"},
    "acc.col_account": {LANG_ENGLISH: "Account", LANG_DARI: "حساب"},
    "acc.col_opening": {LANG_ENGLISH: "Opening", LANG_DARI: "مانده اول"},
    "acc.col_debit": {LANG_ENGLISH: "Debit", LANG_DARI: "بدهکار"},
    "acc.col_credit": {LANG_ENGLISH: "Credit", LANG_DARI: "بستانکار"},
    "acc.col_closing": {LANG_ENGLISH: "Closing Balance", LANG_DARI: "مانده اخیر"},
    "acc.col_figure": {LANG_ENGLISH: "Figure", LANG_DARI: "شرح"},
    "acc.col_amount": {LANG_ENGLISH: "Amount", LANG_DARI: "مبلغ"},
    "acc.col_date": {LANG_ENGLISH: "Date", LANG_DARI: "تاریخ"},
    "acc.col_reference": {LANG_ENGLISH: "Reference", LANG_DARI: "مرجع"},
    "acc.col_description": {LANG_ENGLISH: "Description", LANG_DARI: "شرح"},
    "acc.col_balance": {LANG_ENGLISH: "Balance", LANG_DARI: "مانده"},
    "acc.col_in": {LANG_ENGLISH: "Money In", LANG_DARI: "دریافت"},
    "acc.col_out": {LANG_ENGLISH: "Money Out", LANG_DARI: "پرداخت"},
    "acc.col_party_code": {LANG_ENGLISH: "Code", LANG_DARI: "کود"},
    "acc.col_party": {LANG_ENGLISH: "Name", LANG_DARI: "نام"},
    "acc.col_current": {LANG_ENGLISH: "Current", LANG_DARI: "جاری"},
    "acc.col_1_30": {LANG_ENGLISH: "1–30 days", LANG_DARI: "۱ تا ۳۰ روز"},
    "acc.col_31_60": {LANG_ENGLISH: "31–60 days", LANG_DARI: "۳۱ تا ۶۰ روز"},
    "acc.col_61_90": {LANG_ENGLISH: "61–90 days", LANG_DARI: "۶۱ تا ۹۰ روز"},
    "acc.col_90_plus": {LANG_ENGLISH: "90+ days", LANG_DARI: "بیش از ۹۰ روز"},
    "acc.pl_net_sales": {LANG_ENGLISH: "Net sales", LANG_DARI: "فروش خالص"},
    "acc.pl_cogs": {LANG_ENGLISH: "Less: cost of goods sold",
                    LANG_DARI: "منفی: قیمت تمام‌شد اجناس فروخته‌شده"},
    "acc.pl_gross_profit": {LANG_ENGLISH: "Gross profit", LANG_DARI: "مفاد ناخالص"},
    "acc.pl_expenses": {LANG_ENGLISH: "Less: operating expenses",
                        LANG_DARI: "منفی: مصارف عملیاتی"},
    "acc.pl_other_income": {LANG_ENGLISH: "Add: other income",
                            LANG_DARI: "جمع: عواید دیگر"},
    "acc.pl_net_profit": {LANG_ENGLISH: "Net profit", LANG_DARI: "مفاد خالص"},
    "acc.bs_assets": {LANG_ENGLISH: "ASSETS", LANG_DARI: "دارایی‌ها"},
    "acc.bs_total_assets": {LANG_ENGLISH: "Total assets", LANG_DARI: "مجموع دارایی‌ها"},
    "acc.bs_liabilities": {LANG_ENGLISH: "LIABILITIES", LANG_DARI: "بدهی‌ها"},
    "acc.bs_total_liabilities": {LANG_ENGLISH: "Total liabilities",
                                 LANG_DARI: "مجموع بدهی‌ها"},
    "acc.bs_equity": {LANG_ENGLISH: "EQUITY", LANG_DARI: "سرمایه"},
    "acc.bs_result": {LANG_ENGLISH: "   Result for the period",
                      LANG_DARI: "   نتیجه دوره"},
    "acc.bs_total_equity": {LANG_ENGLISH: "Total equity", LANG_DARI: "مجموع سرمایه"},
    "acc.bs_total_liab_equity": {LANG_ENGLISH: "Total liabilities and equity",
                                 LANG_DARI: "مجموع بدهی‌ها و سرمایه"},
    "acc.sum_debit": {LANG_ENGLISH: "Total debit", LANG_DARI: "مجموع بدهکار"},
    "acc.sum_credit": {LANG_ENGLISH: "Total credit", LANG_DARI: "مجموع بستانکار"},
    "acc.sum_balanced": {LANG_ENGLISH: "Balanced", LANG_DARI: "متوازن"},
    "acc.sum_net_profit": {LANG_ENGLISH: "Net profit", LANG_DARI: "مفاد خالص"},
    "acc.sum_assets": {LANG_ENGLISH: "Total assets", LANG_DARI: "مجموع دارایی‌ها"},
    "acc.sum_liab_equity": {LANG_ENGLISH: "Liabilities + equity",
                            LANG_DARI: "بدهی‌ها + سرمایه"},
    "acc.sum_opening": {LANG_ENGLISH: "Opening", LANG_DARI: "مانده اول"},
    "acc.sum_closing": {LANG_ENGLISH: "Closing", LANG_DARI: "مانده اخیر"},
    "acc.sum_in": {LANG_ENGLISH: "Total in", LANG_DARI: "مجموع دریافت"},
    "acc.sum_out": {LANG_ENGLISH: "Total out", LANG_DARI: "مجموع پرداخت"},
    "acc.sum_total": {LANG_ENGLISH: "Total", LANG_DARI: "مجموع"},
    "acc.yes": {LANG_ENGLISH: "Yes", LANG_DARI: "بلی"},
    "acc.no": {LANG_ENGLISH: "No", LANG_DARI: "نخیر"},
    # ---- Stage 08 costing & valuation ----
    "cost.nav_reports": {LANG_ENGLISH: "Costing & Valuation",
                         LANG_DARI: "قیمت تمام‌شد و ارزش‌گذاری"},
    "cost.reports_title": {LANG_ENGLISH: "Costing & Valuation Reports",
                           LANG_DARI: "گزارش‌های قیمت تمام‌شد و ارزش‌گذاری"},
    "cost.rep_valuation": {LANG_ENGLISH: "Inventory Valuation",
                           LANG_DARI: "ارزش‌گذاری موجودی"},
    "cost.rep_cogs": {LANG_ENGLISH: "Cost of Goods Sold",
                      LANG_DARI: "قیمت تمام‌شد اجناس فروخته‌شده"},
    "cost.rep_gross_profit": {LANG_ENGLISH: "Gross Profit", LANG_DARI: "مفاد ناخالص"},
    "cost.f_warehouse": {LANG_ENGLISH: "Warehouse", LANG_DARI: "گدام"},
    "cost.f_period": {LANG_ENGLISH: "Period", LANG_DARI: "دوره"},
    "cost.filter_all_wh": {LANG_ENGLISH: "All warehouses", LANG_DARI: "همه گدام‌ها"},
    "cost.period_month": {LANG_ENGLISH: "This month", LANG_DARI: "این ماه"},
    "cost.period_year": {LANG_ENGLISH: "This year", LANG_DARI: "امسال"},
    "cost.period_all": {LANG_ENGLISH: "All time", LANG_DARI: "تمام دوره‌ها"},
    "cost.col_item_code": {LANG_ENGLISH: "Item Code", LANG_DARI: "کود جنس"},
    "cost.col_item_name": {LANG_ENGLISH: "Item", LANG_DARI: "جنس"},
    "cost.col_unit": {LANG_ENGLISH: "Unit", LANG_DARI: "واحد"},
    "cost.col_qty": {LANG_ENGLISH: "Quantity", LANG_DARI: "تعداد"},
    "cost.col_avg_cost": {LANG_ENGLISH: "Average Cost", LANG_DARI: "قیمت اوسط"},
    "cost.col_value": {LANG_ENGLISH: "Inventory Value", LANG_DARI: "ارزش موجودی"},
    "cost.col_qty_sold": {LANG_ENGLISH: "Quantity Sold", LANG_DARI: "تعداد فروخته‌شده"},
    "cost.col_cogs": {LANG_ENGLISH: "Cost of Goods Sold", LANG_DARI: "قیمت تمام‌شد"},
    "cost.col_figure": {LANG_ENGLISH: "Figure", LANG_DARI: "شرح"},
    "cost.col_amount": {LANG_ENGLISH: "Amount", LANG_DARI: "مبلغ"},
    "cost.sum_qty": {LANG_ENGLISH: "Total quantity", LANG_DARI: "مجموع تعداد"},
    "cost.sum_value": {LANG_ENGLISH: "Total inventory value",
                       LANG_DARI: "مجموع ارزش موجودی"},
    "cost.sum_cogs": {LANG_ENGLISH: "Total cost of goods sold",
                      LANG_DARI: "مجموع قیمت تمام‌شد"},
    "cost.sum_margin": {LANG_ENGLISH: "Gross margin", LANG_DARI: "حاشیه مفاد"},
    "cost.gp_gross_sales": {LANG_ENGLISH: "Gross sales", LANG_DARI: "فروش ناخالص"},
    "cost.gp_returns": {LANG_ENGLISH: "Less: sales returns", LANG_DARI: "منفی: برگشت فروش"},
    "cost.gp_net_sales": {LANG_ENGLISH: "Net sales", LANG_DARI: "فروش خالص"},
    "cost.gp_cogs": {LANG_ENGLISH: "Less: cost of goods sold",
                     LANG_DARI: "منفی: قیمت تمام‌شد اجناس فروخته‌شده"},
    "cost.gp_profit": {LANG_ENGLISH: "Gross profit", LANG_DARI: "مفاد ناخالص"},
    "cost.col_wh_value": {LANG_ENGLISH: "Value", LANG_DARI: "ارزش"},
    # stock status
    "inv.status_ok": {LANG_ENGLISH: "In Stock", LANG_DARI: "موجود"},
    "inv.status_low": {LANG_ENGLISH: "Low Stock", LANG_DARI: "موجودی کم"},
    "inv.status_out": {LANG_ENGLISH: "Out of Stock", LANG_DARI: "ناموجود"},
    # movement types
    "inv.mt_OPENING": {LANG_ENGLISH: "Opening", LANG_DARI: "موجودی اولیه"},
    "inv.mt_PURCHASE": {LANG_ENGLISH: "Purchase", LANG_DARI: "خرید"},
    "inv.mt_SALE": {LANG_ENGLISH: "Sale", LANG_DARI: "فروش"},
    "inv.mt_SALE_RETURN": {LANG_ENGLISH: "Sales Return", LANG_DARI: "برگشت فروش"},
    "inv.mt_PURCHASE_RETURN": {LANG_ENGLISH: "Purchase Return", LANG_DARI: "برگشت خرید"},
    "inv.mt_ADJUSTMENT_IN": {LANG_ENGLISH: "Adjustment In", LANG_DARI: "تعدیل ورودی"},
    "inv.mt_ADJUSTMENT_OUT": {LANG_ENGLISH: "Adjustment Out", LANG_DARI: "تعدیل خروجی"},
    "inv.mt_TRANSFER_IN": {LANG_ENGLISH: "Transfer In", LANG_DARI: "انتقال ورودی"},
    "inv.mt_TRANSFER_OUT": {LANG_ENGLISH: "Transfer Out", LANG_DARI: "انتقال خروجی"},
    # adjustment form
    "inv.f_item": {LANG_ENGLISH: "Item", LANG_DARI: "جنس"},
    "inv.f_warehouse": {LANG_ENGLISH: "Warehouse", LANG_DARI: "گدام"},
    "inv.f_direction": {LANG_ENGLISH: "Direction", LANG_DARI: "جهت"},
    "inv.dir_in": {LANG_ENGLISH: "Increase (In)", LANG_DARI: "افزایش (ورود)"},
    "inv.dir_out": {LANG_ENGLISH: "Decrease (Out)", LANG_DARI: "کاهش (خروج)"},
    "inv.f_quantity": {LANG_ENGLISH: "Quantity", LANG_DARI: "مقدار"},
    "inv.f_reason": {LANG_ENGLISH: "Reason (required)", LANG_DARI: "دلیل (الزامی)"},
    "inv.f_reason_ph": {LANG_ENGLISH: "Why is the stock changing?",
                        LANG_DARI: "چرا موجودی تغییر می‌کند؟"},
    "inv.current_stock_is": {LANG_ENGLISH: "Current stock: {qty}",
                             LANG_DARI: "موجودی فعلی: {qty}"},
    "inv.act_apply": {LANG_ENGLISH: "Apply Adjustment", LANG_DARI: "ثبت تعدیل"},
    "inv.msg_adjusted": {LANG_ENGLISH: "Stock adjusted. New quantity: {qty}",
                         LANG_DARI: "موجودی تعدیل شد. مقدار جدید: {qty}"},
    "inv.msg_pick_item": {LANG_ENGLISH: "Choose an item first.",
                          LANG_DARI: "ابتدا یک جنس را انتخاب کنید."},
    "inv.msg_need_reason": {LANG_ENGLISH: "Enter the reason for this stock adjustment.",
                            LANG_DARI: "دلیل این تعدیل موجودی را وارد کنید."},
    "inv.msg_bad_qty": {LANG_ENGLISH: "Enter a quantity above zero.",
                        LANG_DARI: "مقداری بیشتر از صفر وارد کنید."},
    # transfer form
    "inv.f_from": {LANG_ENGLISH: "From Warehouse", LANG_DARI: "از گدام"},
    "inv.f_to": {LANG_ENGLISH: "To Warehouse", LANG_DARI: "به گدام"},
    "inv.f_note": {LANG_ENGLISH: "Note", LANG_DARI: "یادداشت"},
    "inv.act_transfer": {LANG_ENGLISH: "Transfer Stock", LANG_DARI: "انتقال موجودی"},
    "inv.msg_transferred": {
        LANG_ENGLISH: "Transferred {qty}. {from_wh}: {from_qty} · {to_wh}: {to_qty}",
        LANG_DARI: "{qty} انتقال شد. {from_wh}: {from_qty} · {to_wh}: {to_qty}"},
    "inv.msg_same_wh": {LANG_ENGLISH: "Choose two different warehouses.",
                        LANG_DARI: "دو گدام متفاوت انتخاب کنید."},
    "inv.available_here": {LANG_ENGLISH: "Available here: {qty}",
                           LANG_DARI: "موجود در اینجا: {qty}"},
    # movement + reports screens
    "inv.filter_all_items": {LANG_ENGLISH: "All items", LANG_DARI: "همه اجناس"},
    "inv.filter_all_wh": {LANG_ENGLISH: "All warehouses", LANG_DARI: "همه گدام‌ها"},
    "inv.filter_all_types": {LANG_ENGLISH: "All types", LANG_DARI: "همه انواع"},
    "inv.empty": {LANG_ENGLISH: "No stock movements for this filter.",
                  LANG_DARI: "برای این فیلتر حرکتی وجود ندارد."},
    "inv.rep_current": {LANG_ENGLISH: "Current Stock", LANG_DARI: "موجودی فعلی"},
    "inv.rep_opening_vs_current": {LANG_ENGLISH: "Opening vs Current",
                                   LANG_DARI: "اولیه در برابر فعلی"},
    "inv.rep_by_warehouse": {LANG_ENGLISH: "Stock by Warehouse",
                             LANG_DARI: "موجودی بر اساس گدام"},
    "inv.rep_movement": {LANG_ENGLISH: "Item Movement", LANG_DARI: "حرکت جنس"},
