...
from zenith_business.services.document_math import assert_journal_balanced
        ...
        with self._db.transaction():
            ...
            for ln in lines:
                self._financial.add_line(
                    entry_id=entry_id, account_id=ln.account_id, debit=ln.debit,
                    credit=ln.credit, party_type=ln.party_type, party_id=ln.party_id,
